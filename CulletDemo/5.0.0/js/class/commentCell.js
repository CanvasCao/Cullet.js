    ...
    CommentCell.prototype = {
        ...
        initCSS: function () {
            ...
            if (that.liked) {
                ...
                this.JM.$cell.find('.commentCenterLike').css({'top': -GM.ccm.config.earMoveDistance, 'opacity': 1});
            }
            ;
        ...
        bindEvent: function () {
            ...
            this.JM.$cell.find('.commentLike').click(function (e) {
                ...
                GM.ccm.start();
                GM.ccm.imgsDown(that.JM.$cell.find('.commentLike,.commentReply'));
            ...
            this.JM.$cell.find('.commentReply').click(function (e) {
                ...
                //var reid = that.reid;
                //var newCommentReid = reid || that.commentsPK;
